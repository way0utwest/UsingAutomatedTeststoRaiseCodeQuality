...
VALUES
      ...
      --, ( 4, GETDATE() , DATEADD( DAY, 5, GETDATE()), DATEADD( DAY, 1, GETDATE()), 1, 0, 'RC23442', '444566', 2, 3,1, 5, 3, 500, 30, 620)
      --, ( 5, GETDATE() , DATEADD( DAY, 5, GETDATE()), DATEADD( DAY, 1, GETDATE()), 1, 0, 'CB23467', '464554', 3, 1,1, 5, 3, 800, 42, 820)
;
